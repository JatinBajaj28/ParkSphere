...
import { Building2, Compass, LogOut, PlusCircle, TrendingUp } from 'lucide-react'
          ...
          <div className="glass-panel form-panel">
            <div className="panel-title-row">
              <div>
                ...
                <h1>Register a location, tune capacity, and publish your next lot.</h1>
              </div>
              <Building2 size={22} />
            </div>
            ...
            <form className="owner-form" onSubmit={handleCreateArea}>
              ...
              <button type="submit" className="primary-action" disabled={loading}>
                <PlusCircle size={18} />
                {loading ? 'Saving...' : 'Register parking area'}
              </button>
            </form>
          </div>
